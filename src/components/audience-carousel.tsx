  ...
  return (
    <div className="mb-14 md:mb-20">
      ...
      <div className="relative">
        ...
        <div 
          className={`absolute top-0 bottom-4 left-[-16px] md:left-[-24px] w-12 md:w-20 bg-gradient-to-r from-background via-background/50 to-transparent pointer-events-none z-10 transition-opacity duration-300 ${
            canScrollLeft ? "opacity-100" : "opacity-0"
          }`} 
        />
        <div 
          className={`absolute top-0 bottom-4 right-[-16px] md:right-[-24px] w-12 md:w-20 bg-gradient-to-l from-background via-background/50 to-transparent pointer-events-none z-10 transition-opacity duration-300 ${
