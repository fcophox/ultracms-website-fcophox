  ...
  const handleSave = async (status: "draft" | "published") => {
    if (!title) {
      setModalConfig({
        ...
        type: 'error',
        title: 'Faltan campos',
        message: 'El título del caso de estudio es requerido.'
      });
      return;
    }
    ...
    try {
      ...
      setModalConfig({
        isOpen: true,
        type: 'success',
        title: status === 'published' ? '¡Caso de estudio publicado!' : '¡Borrador guardado!',
        message: status === 'published'
          ? 'El caso de estudio ha sido publicado correctamente.'
          : 'El caso de estudio se ha guardado como borrador.',
      ...
      setModalConfig({
        ...
        message: error.message || 'Ocurrió un problema al guardar el caso de estudio.'
      });
    } finally {
      setIsSaving(false);
    }
