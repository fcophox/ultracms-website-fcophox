...
export default function NewServicePage() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      setModalConfig({
        ...
        message: 'El servicio ha sido guardado y publicado correctamente.',
      ...
      setModalConfig({
        ...
        message: error.message || 'Ocurrió un problema al guardar el servicio en la base de datos.'
      });
    } finally {
      setIsSaving(false);
    }
  ...
  const handleTranslate = async () => {
    ...
    try {
      ...
      setCurrentLanguage('en'); // Switch tab
    ...
    <div className="flex flex-col h-[calc(100vh-80px)] bg-background">
      ...
      <header className="h-[80px] flex items-center justify-between px-10 border-b border-transparent shrink-0">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-[22px] font-semibold text-foreground tracking-tight">Crear Nuevo Servicio</h1>
        ...
        <div className="flex items-center gap-3">
          ...
          >
            {isSaving ? "Guardando..." : "Publicar Servicio"}
          </button>
        </div>
      </header>
