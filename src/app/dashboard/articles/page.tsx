...
export default async function ArticlesPage() {
  ...
  // Fetch all articles (drafts & published) ordered by created_at desc
    ...
    <div className="px-12 pb-20 pt-10">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-sm text-muted mt-1">Administra tus publicaciones de blog y reflexiones.</p>
        </div>
        <Link 
      ...
      {!articles || articles.length === 0 ? (
        <EmptyState 
          ...
          description="You haven't published any articles. Create your first article to share your knowledge with the world."
        ...
        <div className="border border-border/60 rounded-xl bg-surface overflow-hidden">
          ...
          <div className="divide-y divide-zinc-800/60">
            {articles.map((article) => (
              <div key={article.id} className="grid grid-cols-[60px_1fr_150px_140px_80px_150px] items-center gap-4 px-6 py-4 hover:bg-surface/30 transition-colors">
                {/* Portada */}
                ...
                <div className="truncate pr-4">
                  ...
                  <div className="text-[11px] text-muted/80 mt-0.5">
                    Publicado: {formatDate(article.published_at || article.created_at)}
                  </div>
                </div>
