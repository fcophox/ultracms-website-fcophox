...
export default function EditArticlePage(props: { params: Promise<{ id: string }> }) {
    ...
    async function loadInitialData() {
      try {
        ...
        setModalConfig({
          ...
          message: 'No se pudo cargar el artículo. Por favor intenta de nuevo.'
        });
      } finally {
        setIsLoading(false);
      }
  ...
  const handleTranslate = async () => {
    ...
    try {
      ...
      setCurrentLanguage('en'); // Auto-switch to English tab to see the results
    ...
    <div className="flex flex-col h-[calc(100vh-80px)] bg-background">
      ...
      <header className="h-[80px] flex items-center justify-between px-10 border-b border-transparent shrink-0">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-[22px] font-semibold text-foreground tracking-tight">Editar Artículo</h1>
      ...
      <div className="flex-1 overflow-y-auto px-6 sm:px-10 py-8">
        <div className="max-w-[1400px] mx-auto flex flex-col lg:flex-row gap-8">
          ...
          <div className="flex-1 flex flex-col gap-6">
            ...
            {/* Editor Block */}
            <RichTextEditor
              key={currentLanguage} // Forces Tiptap to re-mount and load the correct content state when switching tabs
