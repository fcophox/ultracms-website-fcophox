    ...
    <div className="px-12 pb-20 pt-10">
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          ...
          <p className="text-sm text-muted mt-1">Actualiza los detalles de tu proyecto.</p>
        </div>
      </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-surface border border-border/60 rounded-xl p-6">
            ...
            <p className="text-xs text-muted mt-2">
              {published ? "Este proyecto es visible públicamente." : "Este proyecto está en borrador."}
            </p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              className="w-full px-5 py-3 rounded-lg bg-red-500/10 text-red-400 font-semibold hover:bg-red-500/20 transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
            >
              {isDeleting ? (
                <>
                  <Loader2 className="w-4 h-4 animate-spin" />
